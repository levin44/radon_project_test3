...
const float SINE_WAVE_MIN_VALUE = 5.0;    // Lowest value of the sine wave
const float SINE_WAVE_MAX_VALUE = 90.0;    // Highest value of the sine wave
const float SINE_WAVE_INTERVAL = 80.0;     // Period in seconds for one complete cycle
